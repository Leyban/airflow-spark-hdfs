...
func CopySabaVirtual(timeEnd time.Time) {
	...
	insertSQL := `INSERT INTO saba_virtual (
        trans_id,
        vendor_member_id,
        operator_id,
        league_id,
	...
	selectSQL := `SELECT * FROM saba_virtual LIMIT 1000`

	var original []SabaVirtualData
	...
	for i := 1; i <= 31; i++ {
		fmt.Println("Inserting SabaVirtual for day", i)
